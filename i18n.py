...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "event.local_port.title":   "Local AI server on port {port} ({label})",
        "event.local_port.details": "A local model server is listening on this machine.\nProcess: {proc}\nPath: {path}",
        "event.local_cmdline.title":   "Local model run: {proc}",
        "event.local_cmdline.details": "The command line contains \"{marker}\" — a model is being run outside the browser. Renaming the program does not hide this.\nProcess: {proc}\nPath: {path}\nPID: {pid}",
        "event.local_model_file.title":   "Model weights on disk: {name}",
        "event.local_model_file.details": "Downloaded model weights are present on this machine, even if nothing is running right now.\nLocation: {path}",
        "event.clipboard.title":   "AI-typical text on the clipboard",
        "event.clipboard.details": "Signals: {signals}\n\nExcerpt: {excerpt}…",
    ...
    "de": {
        ...
        "event.local_port.title":   "Lokaler KI-Server auf Port {port} ({label})",
        "event.local_port.details": "Auf diesem Rechner lauscht ein lokaler Modell-Server.\nProzess: {proc}\nPfad: {path}",
        "event.local_cmdline.title":   "Lokales Modell ausgeführt: {proc}",
        "event.local_cmdline.details": "Die Befehlszeile enthält \"{marker}\" — ein Modell wird außerhalb des Browsers ausgeführt. Umbenennen des Programms ändert daran nichts.\nProzess: {proc}\nPfad: {path}\nPID: {pid}",
        "event.local_model_file.title":   "Modellgewichte auf der Festplatte: {name}",
        "event.local_model_file.details": "Heruntergeladene Modellgewichte sind auf diesem Rechner vorhanden, auch wenn gerade nichts läuft.\nOrt: {path}",
        "event.clipboard.title":   "KI-typischer Text in der Zwischenablage",
        "event.clipboard.details": "Merkmale: {signals}\n\nAuszug: {excerpt}…",
