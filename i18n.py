...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "login.tamper_warning": "⚠ Possible tampering: {count} monitoring event(s) were previously recorded (last at {last}), but the database is now empty. Report this before continuing.",
    ...
    "de": {
        ...
        "login.tamper_warning": "⚠ Mögliche Manipulation: Es wurden zuvor {count} Überwachungs-Ereignisse aufgezeichnet (zuletzt um {last}), die Datenbank ist jetzt aber leer. Bitte vor dem Fortfahren melden.",
